...
pub static HEIGHT_TO_BLOCKHASH: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/blockhash/byheight/")
);
pub static BLOCKHASH_TO_HEIGHT: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/height/byblockhash/")
);
pub static OUTPOINT_TO_RUNES: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/byoutpoint/")
);
pub static HEIGHT_TO_RUNES: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/byheight/")
);

pub static ADDRESS_TO_RUNES: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/byaddress/")
);

pub static ADDRESS_TO_PROTORUNES: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/protorunes/byaddress/")
);

pub static HEIGHT_TO_PROTORUNES: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/protorunes/byheight/")
);
...
pub static HEIGHT_TO_TRANSACTION_IDS: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/txids/byheight")
);
...
pub static OFFSETEND: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/offset/end/")
);
pub static OFFSETSTART: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/offset/start/")
);
pub static HEIGHTSTART: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/height/start/")
);
pub static HEIGHTEND: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/height/end/")
);
pub static AMOUNT: Lazy<IndexPointer> = Lazy::new(|| IndexPointer::from_keyword("/runes/amount/"));
pub static MINTS_REMAINING: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/mints-remaining/")
);
pub static PREMINE: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/premine/")
);
pub static DIVISIBILITY: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runes/divisibility/")
);
...
pub static ETCHING_TO_RUNE_ID: Lazy<IndexPointer> = Lazy::new(||
    IndexPointer::from_keyword("/runeid/byetching/")
);
